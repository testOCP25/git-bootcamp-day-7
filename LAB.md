...
Для задачки пришлось поковыряться - в дефолтной конфиге заводиться не захотел, сначала поменял образ, но это не помогло, в итоге остановился на включении GUI (подвисал на создании ключей) и выделении 1Гб памяти.
...
Снова пришлось покурочить, чтобы завелось, в итоге увеличил RAM, выбрал другой образ:
